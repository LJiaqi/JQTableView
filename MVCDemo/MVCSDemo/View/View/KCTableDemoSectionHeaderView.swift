//
//  KCTableDemoSectionHeaderView.swift
//  MVCDemo
//
...
class KCTableDemoSectionHeaderView: JQSectionView {
    ...
    override func setObject(_ obj: JQTableListSectionItem) {
        ...
        if let obj = obj as? KCTableDemoSectionHeaderItem {
    ...
    override func layoutSubviews() {
        ...
        if let obj = self.item as? KCTableDemoSectionHeaderItem {
